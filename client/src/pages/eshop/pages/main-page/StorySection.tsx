...
export default function StorySection(): JSX.Element {
  const storyLink = navItems.find((item) => ["Our Story"].includes(item.label));
    ...
    <section className="eshop-story-section" data-testid="eshop-story-section">
      <div className="eshop-story-text-content">
        ...
        <p data-testid="story-text">
          ...
          companies and individuals, we have a range of roasted coffee beans,
          equipment and know-how to prepare great coffee in every operation.
        </p>
